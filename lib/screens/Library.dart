                                            ...
                                            children: [
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return TopicInfo(
                                                    topicId:
                                                        todayTopics[index].topic.id!,
                                                    title:
                                                        todayTopics[index].topic.name,
                                                    termNumbers:
                                                        todayTopics[index].termNumbers,
                                                    authorName:
                                                        todayTopics[index].authorName,
                                                    playersCount: todayTopics[index]
                                                        .playersCount,
                                                    userAvatar:
                                                        todayTopics[index].userAvatar,
                                                    userId: _user!.id!,
                                                  );
                                                },
                                              ),
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return TopicInfo(
                                                    topicId:
                                                        yesterdayTopics[index].topic.id!,
                                                    title:
                                                        yesterdayTopics[index].topic.name,
                                                    termNumbers:
                                                        yesterdayTopics[index].termNumbers,
                                                    authorName:
                                                        yesterdayTopics[index].authorName,
                                                    playersCount: yesterdayTopics[index]
                                                        .playersCount,
                                                    userAvatar:
                                                        yesterdayTopics[index].userAvatar,
                                                    userId: _user!.id!,
                                                  );
                                                },
                                              ),
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return TopicInfo(
                                                    topicId:
                                                        thisWeekTopics[index].topic.id!,
                                                    title:
                                                        thisWeekTopics[index].topic.name,
                                                    termNumbers:
                                                        thisWeekTopics[index].termNumbers,
                                                    authorName:
                                                        thisWeekTopics[index].authorName,
                                                    playersCount: thisWeekTopics[index]
                                                        .playersCount,
                                                    userAvatar:
                                                        thisWeekTopics[index].userAvatar,
                                                    userId: _user!.id!,
                                                  );
                                                },
                                              ),
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return TopicInfo(
                                                    topicId:
                                                        olderTopics[index].topic.id!,
                                                    title:
                                                        olderTopics[index].topic.name,
                                                    termNumbers:
                                                        olderTopics[index].termNumbers,
                                                    authorName:
                                                        olderTopics[index].authorName,
                                                    playersCount: olderTopics[index]
                                                        .playersCount,
                                                    userAvatar:
                                                        olderTopics[index].userAvatar,
                                                    userId: _user!.id!,
                                                  );
                                                },
                                              ),
