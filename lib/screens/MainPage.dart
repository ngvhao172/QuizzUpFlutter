    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Consumer<PageProvider>(
            builder: (context, PageProvider provider, child) {
          int nextPage = provider.page;
          print(nextPage);
          // WidgetsBinding.instance.addPostFrameCallback((_) {
          //   navPage.jumpToPage(nextPage);
          //   // _updateIconColor(nextPage);
          // });
          _runsAfterBuild(nextPage);
          return Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    PageProvider dataProvider = context.read<PageProvider>();
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              color: _iconColors[1],
                              fontWeight:
                                  _iconColors[1] == Colors.orange.shade300
                                      ? FontWeight.bold
                                      : FontWeight.normal),
                        )
                      ],
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              color: _iconColors[2],
                              fontWeight:
                                  _iconColors[2] == Colors.orange.shade300
                                      ? FontWeight.bold
                                      : FontWeight.normal),
                        )
                      ],
